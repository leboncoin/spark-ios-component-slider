//
//  SliderViewModelDeprecated.swift
...
class SliderViewModelDeprecated<V>: ObservableObject where V: BinaryFloatingPoint, V.Stride: BinaryFloatingPoint  {

    // MARK: - Private Properties
    private let getColorsUseCase: any SliderGetColorsUseCasableDeprecated
    private let getCornerRadiiUseCase: any SliderGetCornerRadiiUseCasableDeprecated
    private let getStepValuesInBoundsUseCase: any SliderGetStepValuesInBoundsUseCasableDeprecated
    private let getClosestValueUseCase: any SliderGetClosestValueUseCasableDeprecated
    ...
    required init(theme: any Theme,
                  shape: SliderShape,
                  intent: SliderIntent,
                  getColorsUseCase: any SliderGetColorsUseCasableDeprecated = SliderGetColorsUseCaseDeprecated(),
                  getCornerRadiiUseCase: any SliderGetCornerRadiiUseCasableDeprecated = SliderGetCornerRadiiUseCaseDeprecated(),
                  getStepValuesInBoundsUseCase: any SliderGetStepValuesInBoundsUseCasableDeprecated = SliderGetStepValuesInBoundsUseCaseDeprecated(),
                  getClosestValueUseCase: any SliderGetClosestValueUseCasableDeprecated = SliderGetClosestValueUseCaseDeprecated()) {
        self.theme = theme
        self.shape = shape
        self.intent = intent
