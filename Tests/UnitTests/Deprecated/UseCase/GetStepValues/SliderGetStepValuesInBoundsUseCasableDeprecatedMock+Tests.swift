...
final class SliderGetStepValuesInBoundsUseCasableDeprecatedMock<U>: SparkComponentSlider.SliderGetStepValuesInBoundsUseCasableDeprecated where U: BinaryFloatingPoint, U.Stride: BinaryFloatingPoint {
