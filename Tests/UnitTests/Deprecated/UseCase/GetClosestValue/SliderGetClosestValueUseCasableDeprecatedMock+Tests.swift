...
final class SliderGetClosestValueUseCasableDeprecatedMock<U>: SparkComponentSlider.SliderGetClosestValueUseCasableDeprecated where U: BinaryFloatingPoint {
    ...
    func execute<V>(value: V, in values: [V]) -> V where V: BinaryFloatingPoint {
        ...
        return (_executeWithValueAndValues.map { $0(castedValue, castedValues) } ?? executeWithValueAndValuesReturnValue) as? V ?? .nan
    }
