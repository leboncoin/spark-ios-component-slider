...
final class SingleSliderViewModelDeprecatedTests: SliderViewModelDeprecatedWithMocksTests {
    var singleViewModel: SingleSliderViewModelDeprecated<Float>!
    override var viewModel: SliderViewModelDeprecated<Float>! {
        get { return self.singleViewModel }
        set { self.singleViewModel = newValue as? SingleSliderViewModelDeprecated<Float> }
    }
    ...
    override func setUp() {
        super.setUp()
        self.singleViewModel = SingleSliderViewModelDeprecated(
            theme: self.theme,
            shape: self.shape,
            intent: self.intent,
